  ...
  return (
    <div className="overflow-x-hidden font-sans bg-white text-deewan-dark">
      ...
      <section className="container mx-auto px-4 md:px-6 py-16" id="subscribe">
        <h2 className="text-3xl font-extrabold text-center mb-3 text-deewan-dark font-display">Start Simple. Scale Fast.</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          {subscriptionPlans.map((plan, i) => (
            ...
            >
              <div className="mb-2 font-extrabold text-xl text-deewan-primary text-center font-display">{plan.name}</div>
      ...
      <section className="w-full py-8 bg-white border-t border-deewan-primary/10">
        <div className="container mx-auto px-4 md:px-6 flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="text-xl md:text-2xl font-semibold text-deewan-dark mb-4 md:mb-0 font-display">Ready to connect with your customers?</div>
          <Button 
            size="lg"
