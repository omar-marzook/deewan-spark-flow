  ...
  return <>
      ...
      <div className="py-12">
        <div className="container mx-auto px-4 md:px-6 w-full md:w-3/4">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-8 bg-deewan-primary/10 p-8 rounded-2xl shadow-lg max-w-5xl mx-auto">
