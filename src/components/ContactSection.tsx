...
const ContactSection = () => {
  ...
  return (
    <section id="contact-us" className="py-24 relative overflow-hidden">
      ...
      <div className="absolute left-0 top-0 w-full h-full bg-gradient-to-br from-deewan-primary/20 via-purple-200/30 to-deewan-secondary/20"></div>
      
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        {/* Section header */}
        <div className="max-w-3xl mx-auto text-center mb-16">
          <h2 className="text-deewan-dark mb-4">Let's Get <span className="text-deewan-primary">Started</span></h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center max-w-6xl mx-auto">
          ...
          <div className="space-y-8">
            <h3 className="text-3xl font-bold mb-8 text-deewan-dark">Get In Touch</h3>
            ...
            <div className="pt-8">
              ...
              <div className="flex space-x-4">
                <a href="#" className="bg-deewan-primary/10 hover:bg-deewan-primary/20 p-3 rounded-full transition-colors duration-300">
          ...
          <div className="bg-white/70 backdrop-blur-xl border border-white/30 p-8 rounded-lg">
                      ...
                      <FormControl>
                        <div className="relative">
                          <Input 
                            ...
                            {...field} 
                          />
                          <User className="absolute top-2.5 left-3 h-5 w-5 text-deewan-dark/50" />
                        </div>
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                      ...
                      <FormControl>
                        <div className="relative">
                          <Input 
                            ...
                            {...field} 
                          />
                          <Mail className="absolute top-2.5 left-3 h-5 w-5 text-deewan-dark/50" />
                        </div>
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                        ...
                        <FormControl>
                          <div className="relative">
                            <Input 
                              ...
                              {...field} 
                            />
                            <Phone className="absolute top-2.5 left-3 h-5 w-5 text-deewan-dark/50" />
                          </div>
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                        ...
                        <FormControl>
                          <div className="relative">
                            <Input 
                              ...
                              {...field} 
                            />
                            <Building className="absolute top-2.5 left-3 h-5 w-5 text-deewan-dark/50" />
                          </div>
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                      ...
                      <FormControl>
                        <div className="relative">
                          <Textarea 
                            ...
                            className="pl-10 min-h-[120px] bg-white/50"
                            {...field} 
                          />
                          <MessageSquare className="absolute top-2.5 left-3 h-5 w-5 text-deewan-dark/50" />
                        </div>
                      </FormControl>
                      <FormMessage />
                    </FormItem>
