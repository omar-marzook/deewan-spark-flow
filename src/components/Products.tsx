...
const Products = () => {
  const products = [
    ...
    },
    {
      ...
      icon: <Shield className="w-10 h-10 text-deewan-primary-dark" />,
  ...
  return (
    <section id="products" className="py-20 relative">
      <div className="absolute top-40 right-0 w-72 h-72 bg-blue-400 rounded-full mix-blend-multiply filter blur-3xl opacity-10 animate-pulse-slow"></div>
