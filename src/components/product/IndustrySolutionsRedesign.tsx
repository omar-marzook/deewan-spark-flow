  ...
  >
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        >
          ...
          <h2 id="industry-solutions-heading" className="text-3xl md:text-4xl font-bold mb-4 text-black">
            ...
            >
                  <Card 
                    className={cn(
                      ...
                      isActive 
                        ? "bg-white/90 border-deewan-primary/30 shadow-lg" 
                        : "bg-white/50 border-white/50 hover:bg-white/70 hover:shadow-md focus-visible:bg-white/70 focus-visible:shadow-md focus-visible:ring-2 focus-visible:ring-deewan-primary/50"
                    )} 
                      ...
                      <div className="absolute inset-0 flex flex-col justify-between p-8 text-white">
                        <div>
                          <div className="inline-flex items-center bg-white/10 backdrop-blur-md px-5 py-2 rounded-full mb-4">
                            <IndustryIcon className="h-4 w-4 mr-2 text-deewan-secondary" aria-hidden="true" />
                          ...
                          <div className="bg-white/10 backdrop-blur-md rounded-xl p-4 max-w-md border border-white/10 mt-6">
                            ...
                            <ul className="space-y-2" aria-label={`${industry.name} key benefits`}>
                              {industry.id === 'healthcare' ? <>
                                  <li className="flex items-center">
                                    <div className="h-2 w-2 bg-deewan-primary rounded-full mr-2" aria-hidden="true"></div>
                        ...
                        <div className="flex justify-start mt-6">
                          <Button 
                            className="bg-deewan-primary hover:bg-deewan-primary/90 focus:bg-deewan-primary/90 text-white focus:ring-2 focus:ring-white/50 focus:ring-offset-2 focus:ring-offset-deewan-primary"
