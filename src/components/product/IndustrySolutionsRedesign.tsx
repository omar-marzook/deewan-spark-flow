      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        >
          ...
          <p className="text-lg text-deewan-dark/70 max-w-2xl mx-auto">
            Our communication platform adapts to the unique needs of your business sector
          </p>
        </motion.div>
                  ...
                  <Card
                    className={cn(
                      ...
                      isActive 
                        ...
                        : "bg-white/50 border-white/50 hover:bg-white/70 hover:shadow-md"
                    )}
                    ...
                    <CardContent className="p-4">
                      <div className="flex items-center gap-4">
                        <div className={cn(
                          ...
                          isActive 
                            ? "bg-gradient-to-br from-deewan-secondary to-deewan-secondary/70 text-white" 
                            : "bg-white/70 text-deewan-secondary"
                        )}>
                          <IndIcon className="h-6 w-6" />
                        </div>
                        <div className="flex-1">
                          <h3 className={cn(
                            "font-medium transition-colors duration-300 text-lg",
                            isActive ? "text-deewan-dark" : "text-deewan-dark/80"
                          )}>
                            {industry.name}
                          </h3>
                        </div>
                        {isActive && (
                          <div className="text-deewan-primary">
