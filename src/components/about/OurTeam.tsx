      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="mb-20 relative h-72 max-w-4xl mx-auto">
          ...
          <motion.div
            ...
            className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-40 h-40 rounded-full flex items-center justify-center z-10"
            style={{ 
              background: 'linear-gradient(135deg, rgba(33, 161, 124, 0.2), rgba(53, 101, 178, 0.2))',
              backdropFilter: 'blur(8px)',
              border: '1px solid rgba(255, 255, 255, 0.3)'
            }}
          >
            <div className="text-center">
              <img src="/logo.svg" alt="Deewan Logo" className="w-16 h-16 mx-auto mb-2" />
              <p className="font-semibold text-deewan-dark">One Team</p>
            </div>
          </motion.div>
