...
const Hero = () => {
  return (
    <section className="min-h-screen pt-24 pb-16 flex items-center relative overflow-hidden">
      ...
      <div className="absolute top-40 -left-20 w-72 h-72 bg-blue-400 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-pulse-slow"></div>
      <div className="absolute top-40 -right-20 w-72 h-72 bg-purple-400 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-pulse-slow delay-700"></div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="animate-fade-in delay-300">
            <div className="glass-card p-6 md:p-8 relative">
              <div className="absolute -top-10 -right-10 w-20 h-20 bg-deewan-primary/20 rounded-full mix-blend-multiply filter blur-xl"></div>
              <h3 className="text-2xl font-bold mb-4">9+ Billion</h3>
              <p className="text-gray-700 mb-4">Annual transactions processed through our reliable communication platform</p>
