      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="animate-fade-in">
            ...
            <p className="text-xl mb-8 text-deewan-gray max-w-lg">
          ...
          <div className="animate-fade-in delay-300">
            <div className="glass-card p-6 md:p-8 relative">
              ...
              <p className="text-deewan-gray mb-4">Annual transactions processed through our reliable communication platform</p>
              
              <div className="grid grid-cols-2 gap-4 mt-8">
                <div className="glass-card p-4 text-center">
                  <h4 className="text-xl font-bold text-deewan-primary">300+</h4>
                  <p className="text-sm text-deewan-gray">Satisfied Customers</p>
                </div>
                <div className="glass-card p-4 text-center">
                  <h4 className="text-xl font-bold text-deewan-secondary">6+</h4>
                  <p className="text-sm text-deewan-gray">Industries Served</p>
                </div>
              </div>
            </div>
          </div>
